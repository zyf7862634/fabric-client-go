...
const (
	twepoch      = int64(1514736000000) //开始时间截 (2018-01-01)
...
func (s *Snowflake) Generate() UID {
	...
	s.timestamp = now
	r := UID((now-twepoch)<<timestampShift | (s.workerid << workeridShift) | (s.sequence))
